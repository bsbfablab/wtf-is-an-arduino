...
// Variável para animação Blink
const unsigned long t_blink = 100;

// Variável para sinalizar quando há um pedestre esperando
boolean pedWaiting = false;
...
void loop()
{   
  // Aqui mostramos se há um pedestre esperando 
  Serial.print("pedWaiting: ");
  Serial.println(pedWaiting);
...
void state_0()
{
  ...
  // Transição de Estado
  if(isStateTimeOver(0) && pedWaiting)
  {
    state = 1;
    t_init = millis();
  }
